class ConsumableReports::PerPersonsController < ApplicationController
  ...
  def ajax_details
		render :update do |page|
			page.call "window.open", "/consumable_reports/per_persons/ajax_info_list/#{params[:id]}","Project Details - Item Master", "location=0,status=0,scrollbars=yes,width=900,height=500"
		end	
  end
